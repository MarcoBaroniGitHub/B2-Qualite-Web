        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'preview'" class="space-y-4">
            <div class="text-sm text-zinc-400">
              Essayez de copier l'email et de le coller dans le champ de
              confirmation.
            </div>

            <div
              class="rounded-xl border border-zinc-800 bg-zinc-950 p-5 space-y-4"
            >
              <div class="space-y-1">
              ...
              <div class="space-y-1">
                <label class="text-sm text-zinc-400"
                  >Confirmez l'email (Coller autorisé)</label
                >
                <input
                  type="email"
          ...
          <div v-else>
            ...
            >
<code>
&lt;!-- BONNE PRATIQUE : Aucun attribut bloquant --&gt;
...
&lt;!-- &lt;input oncopy=&quot;return false&quot; ... /&gt; --&gt;
            ...
            <p class="mt-3 text-xs text-zinc-500">
              Ne jamais utiliser d'événements JavaScript comme
              <code>onpaste="return false"</code> pour empêcher l'utilisateur de
              coller du contenu.
            </p>
          </div>
        </div>
